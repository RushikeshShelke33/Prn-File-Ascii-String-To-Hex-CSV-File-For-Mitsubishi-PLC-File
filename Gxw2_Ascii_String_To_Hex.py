...
def generate_csv(text, start_register=3000, step_size=1, step_start=0):

    with open("Gxw2PLC_AsciiToHex_F1.csv", mode="w", newline="") as file:
        ...
        for val in hex_pairs:
            ...
            if trackstep == 40:
                ...
                current_step += 1
        current_step += 1
        writer.writerow([current_step, "", "END", ""])

    print("✅ CSV generated: Gxw2PLC_AsciiToHex_F1 File Created.csv")


generate_csv(text=text, start_register=6000, step_size=2, step_start=0)
